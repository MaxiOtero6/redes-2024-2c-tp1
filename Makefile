...
VALID_CLIENT_DOWNLOAD_COMMAND_SW = xterm -e $(PYTHON) $(DOWNLOAD_SCRIPT) -d $(CLIENT_DOWNLOAD_DIR) -n $(CLIENT_FILE) -H $(HOST) -p $(PORT) -a $(SW) -t $(TIMEOUT) &
...
VALID_CLIENT_DOWNLOAD_COMMAND_SACK = xterm -e $(PYTHON) $(DOWNLOAD_SCRIPT) -d $(CLIENT_DOWNLOAD_DIR) -n $(CLIENT_FILE) -H $(HOST) -p $(PORT) -a $(SACK) -t $(TIMEOUT) &
